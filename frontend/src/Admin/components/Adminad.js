      ...
      <div className="dash-content">
        <div className="overview">
          <div className="title">
            ...
            <button className="btn-register-admin p-1 bg-orange-500 rounded-xl text-white" onClick={() => navigate('registerAdmin')}>Đăng ký Admin</button>
          </div>
              ...
              <tbody>
                {filteredAdmins.map((admin, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <button
                        className="btn-lock bg-orange-400 p-1 rounded-xl text-white"
