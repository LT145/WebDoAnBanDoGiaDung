...
const RegisterAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      ...
      try {
        const response = await fetch('http://localhost:5000/api/registeradmin', {
          method: 'POST',
          headers: {
  ...
  return (
    <div className="flex-1 bg-white min-h-screen p-2.5 mt-20 transition-all duration-500 ease-in-out">
      <div id="title">
